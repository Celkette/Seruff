...
/*   Updated: 2025/07/30 08:21:29 by nlaporte         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	close_pipe(t_env *minishell, int i)
{
	if (i % 2)
	{
		if (minishell->exec.fd[0] != -1)
...
static void	init_pipe(t_env *minishell, int i)
{
	if (!minishell)
		return ;
	if (i % 2)
