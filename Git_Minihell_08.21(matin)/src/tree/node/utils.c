...
/*   Updated: 2025/08/19 15:55:38 by cle-rouz         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	(*is_built_in2(t_env *minishell, t_tree *node, char *str))(void *p)
{
	...
	{
		node->need_parent = 1;
		return (&exit_minishell_built_in);
	}
	return (NULL);
}
...
int	(*is_built_in(t_env *minishell, t_tree *node, char *str))(void *p)
{
	...
	return (is_built_in2(minishell, node, str));
}
